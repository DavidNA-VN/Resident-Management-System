...
// Đảm bảo ThongKe được import vào file js này
    ...
    return (_jsx(BrowserRouter, { 
        children: _jsxs(Routes, { 
            children: [
                ...
                _jsx(Route, { path: "/phan-anh", element: _jsx(ProtectedRoute, { allowedRoles: ["to_truong", "to_pho", "can_bo"], children: _jsx(Layout, { children: _jsxs("div", { className: "rounded-xl border border-gray-200/80 bg-white p-8 shadow-sm", children: [_jsx("h1", { className: "text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent", children: "Ph\u1EA3n \u00E1nh Ki\u1EBFn ngh\u1ECB" }), _jsx("p", { className: "mt-2 text-gray-600", children: "Trang n\u00E0y \u0111ang \u0111\u01B0\u1EE3c ph\u00E1t tri\u1EC3n..." })] }) }) }) }), 

                /* ĐÃ SỬA DÒNG NÀY ĐỂ HIỂN THỊ GIAO DIỆN THỐNG KÊ THẬT */
                _jsx(Route, { 
                    path: "/thong-ke", 
